...
;(function ($, window, document, undefined) {
  ...
  Calendar.prototype = {
    showHoverInfo: function (obj) { // hover 时显示当天信息
      ...
      var offset_t = $(obj).offset().top + (this.$calendar_today.height() - $(obj).height()) / 2 -150;
      var offset_l = $(obj).offset().left - 1000;
      ...
      this.$calendar_today
            .css({left: offset_l + 0, top: offset_t})
            .stop()
            .animate({left: offset_l + 0, top: offset_t, opacity: 1});
